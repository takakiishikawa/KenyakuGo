    ...
    <div>
      ...
      <div className="grid grid-cols-3 gap-5 mb-8">
        ...
        <Card className="p-7 animate-fade-up" style={{ animationDelay: "80ms", animationFillMode: "both" }}>
          <p className="text-xs font-medium uppercase tracking-widest mb-3 text-muted-foreground">{labels.prev}との差額</p>
        ...
        <Card className="p-7 animate-fade-up" style={{ animationDelay: "160ms", animationFillMode: "both" }}>
          <p className="text-xs font-medium uppercase tracking-widest mb-3 text-muted-foreground">気になる支出</p>
          {feedbackLoading ? (
      ...
      <Card className="p-7">
        <div className="flex items-center gap-2 mb-5">
          <span className="text-xs font-medium uppercase tracking-widest text-muted-foreground">支出の振り返り</span>
        ...
        {feedbackLoading ? (
          ...
          <p className="text-sm text-muted-foreground">取引データを同期すると振り返りが表示されます</p>
        )}
      </Card>
    </div>
  );
