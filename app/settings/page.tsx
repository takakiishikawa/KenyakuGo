    ...
    <div>
      ...
      <div className="mt-8 space-y-5 max-w-xl">
        <Card className="p-7 animate-fade-up">
          <p className="text-xs font-medium uppercase tracking-widest mb-6 text-muted-foreground">予算設定</p>
          <div className="space-y-5">
            <div>
              <label className="block text-sm font-medium mb-2 text-foreground">合計月支出（VND）</label>
              <Input
                type="number"
                value={targetMonthly}
            ...
            <div>
              <label className="block text-sm font-medium mb-2 text-foreground">固定費（VND）</label>
              <Input
                type="number"
                value={fixedCosts}
        ...
        <Card className="p-7 animate-fade-up" style={{ animationDelay: "80ms" }}>
          <p className="text-xs font-medium uppercase tracking-widest mb-5 text-muted-foreground">Googleアカウント</p>
          {user ? (
            <div className="flex items-center gap-4">
              ...
              <div>
                <p className="text-sm font-medium text-foreground">{user.user_metadata?.full_name as string}</p>
        ...
        <Card className="p-7 animate-fade-up" style={{ animationDelay: "160ms", border: "1px solid rgba(239,83,80,0.2)", background: "rgba(239,83,80,0.04)" }}>
          ...
          <p className="text-sm mb-5 text-muted-foreground">全ての取引データを削除します。この操作は取り消せません。</p>
          <AlertDialog>
            <AlertDialogTrigger asChild>
              <Button variant="destructive" size="sm" className="bg-destructive/10 text-destructive border border-destructive/25 hover:bg-destructive/20">
                全取引データを削除
              </Button>
            </AlertDialogTrigger>
            <AlertDialogContent>
