...
export const DICT = {
  ja: {
    ...
    spending: "支出",
    savingsTab: "貯蓄",
    savingsAsOfYearEnd: "貯蓄 ({year}年12月末)",
    ...
    cashCap: "現金上限額",
    cashCapHelp: "これを超える見込みの現金は、投資に回す比率とは別に、超過ぶん全額を投資に回します。0は上限なし。",
    cashCapPlaceholder: "0 (上限なし)",
  ...
  en: {
    ...
    spending: "Spending",
    savingsTab: "Savings",
    savingsAsOfYearEnd: "Savings (end of {year})",
    ...
    cashCap: "Cash cap",
    cashCapHelp: "Cash expected to exceed this amount is moved to investing in full (on top of the invested share). 0 means no cap.",
    cashCapPlaceholder: "0 (no cap)",
